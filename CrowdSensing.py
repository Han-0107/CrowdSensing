...
# 第四个实验：任务次数/个人能力方差[50:550:50]11组  中间值300   [0.06:0.02:0.14]5组  中间值0.1
# 个人能力均值0.5

# 向协作能力向量中添加随机噪声来实现我们对于协作能力的估计
# 具体方式为：在任务数较小时，令噪声很大，说明前期不可能得到准确的估计值。
#           随着任务次数的增多，噪声逐渐减小，估计值逐渐趋向于真实值。

# p_co_ability为协作能力估计值
# p_si_ability为个人能力估计值
# co_ability为真实的协作能力
# si_ability为真实的个人能力
